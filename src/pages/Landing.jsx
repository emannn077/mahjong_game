...
const Landing = ({ start }) => (
  <div className="landing">
      ...
      <svg viewBox="0 0 500 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="svg-float1 svg-delay1">
          <rect
            ...
            strokeWidth="1"
          />
          <text x="260" y="80" textAnchor="middle" fontSize="22" fill="#c1121f">
            🀄
          </text>
          <text
            x="260"
        ...
        <g className="svg-float1 svg-delay3">
          <rect
            ...
            strokeWidth="1"
          />
          <text x="420" y="94" textAnchor="middle" fontSize="22" fill="#2d6a4f">
            🀀
          </text>
          <text
            x="420"
        ...
        <circle
          ...
          r="1.5"
          fill="#f4c842"
          className="svg-sparkle svg-sparkle-delay"
        />
        <circle
          cx="250"
          cy="15"
    ...
    <div className="lb-wrap">
      <div className="lb-title">Score Board</div>
      <Leaderboard />
    </div>
  </div>
)
